...
int main() {
    ...
    HANDLE hChild1 = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)OS04_02_T1, NULL, 0, &childId_T1); //LPTHREAD_START_ROUTINE - указывает на функцию, которая оповещает о начале выполнения потока
